    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="form-group">
                <label>제품명:</label>
                <input type="text" id="productName" value="상품 A" style="width: 100%; padding: 5px;">
            </div>
            <div class="form-group">
                <label>설명:</label>
            ...
            <div class="form-group">
                <label>가격:</label>
                <input type="number" id="productPrice" value="10000" style="width: 100%; padding: 5px;">
            </div>
            <div class="form-group">
                <label>재고:</label>
                <input type="number" id="productStock" value="10" style="width: 100%; padding: 5px;">
            </div>
            <div class="actions">
